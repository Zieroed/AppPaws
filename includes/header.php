    ...
    <div class="container">
        <section class="top-bar" style="display: flex; align-items: center; justify-content: space-between;">
            <div style="flex: 1; display: flex; align-items: center; gap: 20px;">
                <a class="title" href="index.php" style="display: flex; align-items: center; gap: 10px;">
            ...
            <div class="header-right" style="flex: 2; display: flex; justify-content: flex-end; align-items: center;">
                ...
                <?php if (isset($_SESSION["fname"])): ?>
                    ...
                    <form id="myform" action="/AppPaws/accounts/logout.php" method="post" style="margin:0; padding:0; border:none; background:none; display:inline;">
                        <button id="logout" type="submit" style="background-color: #f88624; border: solid #f88624; border-radius: 30px; color: white; transition: background 0.2s, border 0.2s; font: inherit; padding: 10px 20px; cursor: pointer; margin-left: 10px;">Log out</button>
                    </form>
                <?php else: ?>
